...
namespace TestSharpShapes
{
    ...
    public class UnitTesttrap
    {
        ...
        {
            Trapezoid trap = new trap(4);
            Assert.AreEqual(4, trap.SideCount);
        ...
        {
            Trapezoid trap = new trap(10, 16, 4);
